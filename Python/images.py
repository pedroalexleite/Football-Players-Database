...
def crop_info():
    directory = '/Users/pedroalexleite/Desktop/FPD/Generated/Informations'
    crop_height = 30
...
def rotate_heatmaps():
    directory = '/Users/pedroalexleite/Desktop/FPD/Generated/HeatMaps'
    for filename in os.listdir(directory):
        if filename.endswith('.png'):
            filepath = os.path.join(directory, filename)
            with Image.open(filepath) as image:
...
def head_shots(players):
    for index, player in players.iterrows():
        ...
        if response.status_code == 200:
            save_directory = '/Users/pedroalexleite/Desktop/FPD/Generated/Headshots'
...
directory_path = '/Users/pedroalexleite/Desktop/FPD/Generated/HeadShots'
