...
write.csv(outfieldplayers, "/Users/pedroalexleite/Desktop/FPD/Players/Dataframes/outfieldplayers.csv", row.names=FALSE)

#convert to a csv file the final dataframe for the goalkeepers
write.csv(goalkeepers, "/Users/pedroalexleite/Desktop/FPD/Players/Dataframes/goalkeepers.csv", row.names=FALSE)
